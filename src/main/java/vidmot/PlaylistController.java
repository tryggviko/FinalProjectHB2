...
public class PlaylistController {
    ...
    //byrjar á að hlaða playlistanum frá playlists directorinu
    public void initialize() {
        loadPlaylistFromFile();
    }


    // aðferðin þegar þegar ítt er á lögin og skipt um scene til að spila þau
    private void songButtonClick(ActionEvent event) {
        try {
    ...
    private void updateSongsList() {
        ...
        for (String songPath : currentPlaylist.getSongPaths()) {
            ...
            songButton.setOnAction(event -> songButtonClick(event));
